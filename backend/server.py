"""FastAPI backend for LLM Council - Server entry point with session memory."""
    ...
    async def event_generator():
        try:
            ...
            stage2_results, label_to_model = await stage2_collect_rankings(
                request.content, stage1_results, conversation_history
            )
            ...
            stage3_result = await stage3_synthesize_final(
                request.content, stage1_results, stage2_results, conversation_history
            )
